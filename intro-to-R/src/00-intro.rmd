...
- New methods are almost always released in R first. If you want the cutting edge, use R.
...
- R is more free-form, resembling more traditional programming languages.
...
These course notes are a slightly modified version of notes created by Westat data scientist, Gonzalo Rivero.