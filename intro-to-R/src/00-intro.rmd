...
- Very flexible & extensible: Good support for metaprogramming, first class functions, first-class environments.
...
- R is more free form. More closely resembles other languages (e.g., Python, Matlab).
...
- Most data scientists don't use SAS. Most statisticians don't use Python. R is a common tongue.
